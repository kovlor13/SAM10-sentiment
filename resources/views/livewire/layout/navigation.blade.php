                ...
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('dashboard') }}">
                            <img src="{{ asset('images/LOGOWHITE.png') }}" alt="Logo" class="block h-9 w-auto">
                        </a>
                    </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @csrf
                            <button type="submit" class="inline-flex items-center px-3 py-2 border-transparent text-gray-300 text-xs bg-transparent hover:bg-gray-800 hover:text-white focus:outline-none transition ease-in-out duration-150 ml-1">
                                {{ __('Log Out') }}
                            </button>
                        </form>
                        </x-slot>
